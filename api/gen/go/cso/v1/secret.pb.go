...
func (x *Secret) GetPath() isSecret_Path {
	if x != nil {
		return x.Path
	}
	return nil
...
func (x *Secret) GetInfrastructure() *Infrastructure {
	if x != nil {
		if x, ok := x.Path.(*Secret_Infrastructure); ok {
...
func (x *Secret) GetPlatform() *Platform {
	if x != nil {
		if x, ok := x.Path.(*Secret_Platform); ok {
			return x.Platform
		}
	}
	return nil
...
func (x *Secret) GetProduct() *Product {
	if x != nil {
		if x, ok := x.Path.(*Secret_Product); ok {
			return x.Product
		}
	}
	return nil
...
func (x *Secret) GetApplication() *Application {
	if x != nil {
		if x, ok := x.Path.(*Secret_Application); ok {
...
func (x *Secret) GetArtifact() *Artifact {
	if x != nil {
		if x, ok := x.Path.(*Secret_Artifact); ok {
			return x.Artifact
		}
	}
	return nil
...
var file_cso_v1_secret_proto_rawDesc = string([]byte{
...
var (
	...
	file_cso_v1_secret_proto_rawDescData []byte
)

func file_cso_v1_secret_proto_rawDescGZIP() []byte {
	file_cso_v1_secret_proto_rawDescOnce.Do(func() {
		file_cso_v1_secret_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cso_v1_secret_proto_rawDesc), len(file_cso_v1_secret_proto_rawDesc)))
	})
...
var (
	...
	file_cso_v1_secret_proto_goTypes   = []any{
...
func file_cso_v1_secret_proto_init() {
	...
	file_cso_v1_secret_proto_msgTypes[0].OneofWrappers = []any{
		(*Secret_Meta)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cso_v1_secret_proto_rawDesc), len(file_cso_v1_secret_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
