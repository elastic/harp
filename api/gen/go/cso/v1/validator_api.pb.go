...
var file_cso_v1_validator_api_proto_rawDesc = string([]byte{
...
var (
	...
	file_cso_v1_validator_api_proto_rawDescData []byte
)

func file_cso_v1_validator_api_proto_rawDescGZIP() []byte {
	file_cso_v1_validator_api_proto_rawDescOnce.Do(func() {
		file_cso_v1_validator_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cso_v1_validator_api_proto_rawDesc), len(file_cso_v1_validator_api_proto_rawDesc)))
	})
...
var (
	...
	file_cso_v1_validator_api_proto_goTypes  = []any{
...
func file_cso_v1_validator_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cso_v1_validator_api_proto_rawDesc), len(file_cso_v1_validator_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
