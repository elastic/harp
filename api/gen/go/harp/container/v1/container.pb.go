...
var file_harp_container_v1_container_proto_rawDesc = string([]byte{
...
var (
	...
	file_harp_container_v1_container_proto_rawDescData []byte
)

func file_harp_container_v1_container_proto_rawDescGZIP() []byte {
	file_harp_container_v1_container_proto_rawDescOnce.Do(func() {
		file_harp_container_v1_container_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_harp_container_v1_container_proto_rawDesc), len(file_harp_container_v1_container_proto_rawDesc)))
	})
...
var (
	...
	file_harp_container_v1_container_proto_goTypes  = []any{
...
func file_harp_container_v1_container_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_harp_container_v1_container_proto_rawDesc), len(file_harp_container_v1_container_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
