...
type SecretSuffix struct {
	...
	Content map[string]string `protobuf:"bytes,5,rep,name=content,proto3" json:"content,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_harp_bundle_v1_template_proto_rawDesc = string([]byte{
...
var (
	...
	file_harp_bundle_v1_template_proto_rawDescData []byte
)

func file_harp_bundle_v1_template_proto_rawDescGZIP() []byte {
	file_harp_bundle_v1_template_proto_rawDescOnce.Do(func() {
		file_harp_bundle_v1_template_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_harp_bundle_v1_template_proto_rawDesc), len(file_harp_bundle_v1_template_proto_rawDesc)))
	})
...
var (
	...
	file_harp_bundle_v1_template_proto_goTypes  = []any{
...
func file_harp_bundle_v1_template_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_harp_bundle_v1_template_proto_rawDesc), len(file_harp_bundle_v1_template_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
