...
type Bundle struct {
	...
	// User data storage
	UserData      map[string]*anypb.Any `protobuf:"bytes,99,rep,name=user_data,json=userData,proto3" json:"user_data,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Package struct {
	...
	Versions map[uint32]*SecretChain `protobuf:"bytes,5,rep,name=versions,proto3" json:"versions,omitempty" protobuf_key:"fixed32,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// User data storage
	UserData      map[string]*anypb.Any `protobuf:"bytes,99,rep,name=user_data,json=userData,proto3" json:"user_data,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
var file_harp_bundle_v1_bundle_proto_rawDesc = string([]byte{
...
var (
	...
	file_harp_bundle_v1_bundle_proto_rawDescData []byte
)

func file_harp_bundle_v1_bundle_proto_rawDescGZIP() []byte {
	file_harp_bundle_v1_bundle_proto_rawDescOnce.Do(func() {
		file_harp_bundle_v1_bundle_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_harp_bundle_v1_bundle_proto_rawDesc), len(file_harp_bundle_v1_bundle_proto_rawDesc)))
	})
...
var (
	...
	file_harp_bundle_v1_bundle_proto_goTypes  = []any{
...
func file_harp_bundle_v1_bundle_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_harp_bundle_v1_bundle_proto_rawDesc), len(file_harp_bundle_v1_bundle_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
