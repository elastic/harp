...
type PatchOperation struct {
	...
	// Key and Value can be templatized.
	Update map[string]string `protobuf:"bytes,3,rep,name=update,proto3" json:"update,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Replace case-sensitive existing key using the associated value.
	// Value can be templatized.
	ReplaceKeys map[string]string `protobuf:"bytes,4,rep,name=replaceKeys,proto3" json:"replaceKeys,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
var file_harp_bundle_v1_patch_proto_rawDesc = string([]byte{
...
var (
	...
	file_harp_bundle_v1_patch_proto_rawDescData []byte
)

func file_harp_bundle_v1_patch_proto_rawDescGZIP() []byte {
	file_harp_bundle_v1_patch_proto_rawDescOnce.Do(func() {
		file_harp_bundle_v1_patch_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_harp_bundle_v1_patch_proto_rawDesc), len(file_harp_bundle_v1_patch_proto_rawDesc)))
	})
...
var (
	...
	file_harp_bundle_v1_patch_proto_goTypes  = []any{
...
func file_harp_bundle_v1_patch_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_harp_bundle_v1_patch_proto_rawDesc), len(file_harp_bundle_v1_patch_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
