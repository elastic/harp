...
const (
	BundleAPI_GetSecret_FullMethodName = "/harp.bundle.v1.BundleAPI/GetSecret"
)
...
func (c *bundleAPIClient) GetSecret(ctx context.Context, in *GetSecretRequest, opts ...grpc.CallOption) (*GetSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, BundleAPI_GetSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBundleAPIServer must be embedded to have
...
func (UnimplementedBundleAPIServer) testEmbeddedByValue()                   {}
...
func RegisterBundleAPIServer(s grpc.ServiceRegistrar, srv BundleAPIServer) {
	// If the following call pancis, it indicates UnimplementedBundleAPIServer was
...
func _BundleAPI_GetSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BundleAPI_GetSecret_FullMethodName,
	}
